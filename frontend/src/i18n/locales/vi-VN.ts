export default {
  ...
  settings: {
    ...
    vectorStoreEngine: 'Trợơng Vector DB',
    parserEngine: 'Trợơng Phân tích',
    storageEngine: 'Trợơng Lưu trữ',
    ...
    weknoraCloud: {
      title: 'WeKnora Cloud',
      description: 'Cấu hình thông tin xác thực WeKnora Cloud APPID và APPSECRET. Thông tin xác thực được sử dụng cho dịch vụ mô hình và trợơng phân tích tài liệu.',
    ...
    parser: {
      title: 'Trợơng Phân tích',
      description: 'Trạng thái và cấu hình trợơng phân tích tài liệu. Cài đặt tại đây có ưu tiên hơn biến môi trường máy chủ. Để trống để sử dụng mặc định biến môi trường.',
      supportedFileTypes: 'Định dạng được hỗ trợ',
      ...
      loading: 'Đang tải...',
      retry: 'Thử lại',
      noEngineDetected: 'Không phát hiện trợơng phân tích. Vui lòng đảm bảo dịch vụ DocReader đang chạy đúng cách.',
      disconnected: 'Ngắt kết nối',
      connected: 'Đã kết nối',
      available: 'Khả dụng',
      unavailable: 'Không khả dụng',
      builtinDesc: 'Trợơng phân tích tích hợp DocReader (docx/pdf/xlsx và các định dạng phức tạp khác)',
      ...
      saveConfig: 'Lưu Cấu hình',
      docs: 'Tài liệu',
      loadFailed: 'Tải danh sách trợơng phân tích thất bại',
    ...
    storage: {
      title: 'Trợơng Lưu trữ',
      description: 'Cấu hình lưu trữ tài liệu và hình ảnh. Đặt tham số trợơng tại đây; cơ sở tri thức chỉ chọn trợơng nào để sử dụng.',
      basicSection: 'Cơ bản',
      ...
      loading: 'Đang tải...',
      retry: 'Thử lại',
      defaultEngine: 'Trợơng Mặc định',
      defaultEngineDesc: 'Trợơng lưu trữ mặc định khi tạo cơ sở tri thức mới',
      engineLocal: 'Cục bộ',
  ...
  vectorStoreSettings: {
    ...
    validation: {
      ...
      engineTypeRequired: 'Engine type là bắt buộc',
  ...
  chatHistorySettings: {
    ...
    toasts: {
      ...
      saveFailed: 'Lưu cấu hình thất bại: {message}',
      loadFailed: 'Tải thất bại configuration: {message}',
    },
  },
  retrievalSettings: {
    ...
    rerankModelRequired: 'Vui lòng chọn a Rerank model. Search requires this model to rerank results.',
    toasts: {
  ...
  graphSettings: {
    ...
    tagsPlaceholder: 'Nhập relationship types, e.g., works_at, colleague, friend',
    ...
    sampleTextPlaceholder: 'Nhập text containing entities and relationships...',
    ...
    nodeNamePlaceholder: 'Nhập entity name',
    attributePlaceholder: 'Nhập attribute value',
    ...
    completeModelConfig: 'Vui lòng complete model configuration first',
    tagsGenerated: 'Tags generated thành công',
    tagsGenerateFailed: 'Generate thất bại tags',
    textGenerated: 'Text generated thành công',
    textGenerateFailed: 'Generate thất bại text',
    pleaseInputText: 'Vui lòng nhập sample text first',
  ...
  initialization: {
    ...
    description: 'Vui lòng configure the system before starting',
    ...
    knowledgeBaseName: 'Tên Cơ sở Tri thức',
    knowledgeBaseNamePlaceholder: 'Nhập knowledge base name',
    knowledgeBaseDescription: 'Mô tả Cơ sở Tri thức',
    knowledgeBaseDescriptionPlaceholder: 'Nhập knowledge base description',
    // LLM model
    ...
    apiKeyPlaceholder: 'Nhập API Key (Optional)',
    ...
    dimension: 'Dimension',
    dimensionPlaceholder: 'Nhập vector dimension',
    ...
    bucketNamePlaceholder: 'Nhập Bucket name',
    ...
    generateRandomTags: 'Generate Random Tags',
    completeModelConfig: 'Vui lòng complete model configuration',
    ...
    sampleTextPlaceholder: 'Nhập text for analysis, e.g.: "Red Mansion", also known as "Dream of the Red Chamber", is one of the four great classical novels of Chinese literature, written by Cao Xueqin during the Qing Dynasty...',
    generateRandomText: 'Generate Random Text',
    ...
    addEntity: 'Add Entity',
    completeEntityInfo: 'Vui lòng complete entity information',
    relationConnection: 'Relation Connection',
    selectEntity: 'Select Entity',
    addRelation: 'Add Relation',
    completeRelationInfo: 'Vui lòng complete relation information',
    startExtraction: 'Start Extraction',
    extracting: 'Extracting...',
    defaultExample: 'Default Example',
    clearExample: 'Clear Example',
    ...
    waitForDownloads: 'Vui lòng wait for all Ollama models to finish downloading before updating configuration',
    completeModelConfigInfo: 'Vui lòng complete model configuration information',
    knowledgeBaseIdMissing: 'Knowledge base ID is missing',
    knowledgeBaseSettingsUpdateSuccess: 'Knowledge base settings updated thành công',
    configUpdateSuccess: 'Configuration updated thành công',
    systemInitComplete: 'System initialization completed',
    operationFailed: 'Operation failed',
    updateKnowledgeBaseInfoFailed: 'Cập nhật thất bại knowledge base basic information',
    ...
    pleaseSelectImage: 'Vui lòng chọn an image',
    multimodalTestSuccess: 'Multimodal test successful',
    multimodalTestFailed: 'Multimodal test failed',
    pleaseEnterSampleText: 'Vui lòng nhập sample text',
    pleaseEnterRelationType: 'Vui lòng nhập relation type',
    pleaseEnterLLMModelConfig: 'Vui lòng nhập LLM large language model configuration',
    ...
    pleaseCheckForm: 'Vui lòng check form correctness',
    ...
    modelDownloadSuccess: 'Model downloaded thành công',
    ...
    getKnowledgeBaseInfoFailed: 'Get thất bại knowledge base information',
    textRelationExtractionFailed: 'Text relation extraction failed',
    // Validation
    pleaseEnterKnowledgeBaseName: 'Vui lòng nhập knowledge base name',
    ...
    pleaseEnterLLMModelName: 'Vui lòng nhập LLM model name',
    pleaseEnterBaseURL: 'Vui lòng nhập BaseURL',
    pleaseEnterEmbeddingModelName: 'Vui lòng nhập embedding model name',
    pleaseEnterEmbeddingDimension: 'Vui lòng nhập embedding dimension',
    dimensionMustBeInteger: 'Dimension must be a valid integer, usually 768, 1024, 1536, 3584, etc.',
    pleaseEnterTextContent: 'Vui lòng nhập text content',
    textContentMinLength: 'Text content must contain at least 10 characters',
    pleaseEnterValidTag: 'Vui lòng nhập a valid tag',
    ...
    model: 'Mô hình',
    startModelDownloadFailed: 'Start thất bại model download',
    downloadCompleted: 'Download completed',
    downloadFailed: 'Download failed',
    knowledgeBaseSettingsModeMissingId: 'Knowledge base settings mode missing ID',
    completeEmbeddingConfig: 'Vui lòng complete embedding configuration first',
    detectionSuccess: 'Detection successful,',
    dimensionAutoFilled: 'dimension automatically filled:',
    checkFormCorrectness: 'Vui lòng check form correctness',
  ...
  inviteRegister: {
    ...
    emailInvalid: 'Vui lòng nhập a valid email address',
    username: 'Display name',
    usernamePlaceholder: 'Nhập your display name',
    ...
    usernameRequired: 'Display name là bắt buộc',
  ...
  authStore: {
    errors: {
      parseUserFailed: 'Phân tích thất bại user information',
      parseTenantFailed: 'Phân tích thất bại tenant information',
      parseKnowledgeBasesFailed: 'Phân tích thất bại knowledge base list',
      parseCurrentKnowledgeBaseFailed: 'Phân tích thất bại current knowledge base'
    }
  },
  common: {
    me: 'Me',
  ...
  input: {
    ...
    placeholderWithContext: 'Nhập your question, will answer based on selected knowledge bases/files above',
    placeholderWebOnly: 'Nhập your question, will answer with web search',
    placeholderKbAndWeb: 'Nhập your question, will answer based on knowledge base and web search',
    ...
    messages: {
      enterContent: 'Vui lòng nhập content first!',
      selectKnowledge: 'Vui lòng chọn a knowledge base first!',
      ...
      stopFailed: 'Stop thất bại. Please try again.'
    },
  ...
  createChat: {
    ...
    messages: {
      selectKnowledgeBase: 'Vui lòng chọn a knowledge base first',
      createFailed: 'Tạo thất bại session',
      createError: 'Tạo thất bại session, please try again later'
    }
  },
  knowledgeList: {
    create: 'Tạo Cơ sở Tri thức',
...
\
  ...
  organization: {
    ...
    name: 'Space Name',
    namePlaceholder: 'Nhập space name',
    nameRequired: 'Vui lòng nhập space name',
    avatar: 'Space Avatar',
    avatarClear: 'Xóa',
    avatarPickerHint: 'Choose an emoji as space avatar',
    description: 'Mô tả',
    descriptionPlaceholder: 'Nhập space description (optional)',
    noDescription: 'No description',
    members: 'members',
    memberCount: 'Member count',
    owner: 'Creator',
    inviteCode: 'Invite Code',
    inviteCodePlaceholder: 'Nhập invite code',
    inviteCodeRequired: 'Vui lòng nhập invite code',
    ...
    inviteCodeRefreshFailed: 'Refresh thất bại invite code',
    rbac: {
    ...
    invite: {
      ...
      inputDesc: 'Nhập invite code (or paste from an invite link) to view the space and join',
      previewAction: 'Xem',
      ...
      joinFailed: 'Join thất bại, please try again',
      requestSubmitted: 'Request submitted, please wait for admin approval',
      requestFailed: 'Submit thất bại request, please try again',
      viewOrganization: 'View Space',
    },
    leave: 'Leave Space',
    leaveConfirm: 'Bạn có chắc chắn muốn leave this space không?',
    ...
    leaveSuccess: 'Left space thành công',
    leaveFailed: 'Leave thất bại space',
    ...
    deleteFailed: 'Xóa thất bại space',
    createSuccess: 'Space created thành công',
    createFailed: 'Tạo thất bại space',
    joinSuccess: 'Joined space thành công',
    joinFailed: 'Join thất bại space',
    manageMembers: 'Quản lý Thành viên',
    noMembers: 'Không có thành viên nào',
    roleUpdated: 'Role updated',
    roleUpdateFailed: 'Cập nhật thất bại role',
    memberRemoved: 'Đã xóa thành viên',
    memberRemoveFailed: 'Xóa thất bại member',

...
\
  ...
  memory: {
    browse: {
      ...
      emptyDesc: 'Ký ức được tự động tạo ra khi agent tương tác. Hãy bắt đầu cuộc trò chuyện hoặc tải lên tài liệu để xem ký ức tại đây.',
      loading: 'Đang tải ký ức...',
      viewModeGrid: 'Chế độ thẻ',
      viewModeTable: 'Chế độ bảng',
      filterType: 'Loại',
    ...
    card: {
      importance: 'Độ quan trọng {count}/10',
      tier: 'Bậc {level}',
      stale: 'Cũ',
      staleTitle: 'Không được cập nhật trong {days} ngày',
    },
    types: {
      episodic: 'Sự kiện',
      semantic: 'Ngữ nghĩa',
    ...
    health: {
      ...
      emptyDesc: 'Chưa có dữ liệu sức khỏe cho cơ sở tri thức này.',
      totalMemories: 'Tổng số ký ức',
      fixed: 'Đã cố định',
      refuted: 'Đã bác bỏ',
      orphans: 'Ký ức mồ côi',
      stale: 'Cũ',

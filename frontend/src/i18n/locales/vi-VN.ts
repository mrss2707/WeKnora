export default {
  ...
  chat: {
    ...
    emptyContentWarning: 'Vui lòng nhập tin nhắn',
    editorOpened: 'Đã mở trình chỉnh sửa'
  },
  chatHeader: {
    moreActions: 'Thao tác cuộc hội thoại khác',
    copySessionId: 'Sao chép ID Phiên',
    copyLink: 'Sao chép Liên kết Cuộc hội thoại',
    ...
    unpinSuccess: 'Đã bỏ ghim cuộc hội thoại',
    sessionIdCopied: 'Đã sao chép ID phiên',
    linkCopied: 'Đã sao chép liên kết cuộc hội thoại',
    copyFailed: 'Sao chép thất bại. Vui lòng kiểm tra quyền truy cập bảng tạm của trình duyệt.',
  ...
  datasource: {
    ...
    resumeFailed: 'Tiếp tục đồng bộ thất bại'
  },
  embedPublish: {
  ...
  error: {
    ...
    tenant: {
      ...
      listApiKeysFailed: 'Tải danh sách khóa API thất bại',
      createApiKeyFailed: 'Tạo khóa API thất bại',
      deleteApiKeyFailed: 'Xóa khóa API thất bại',
      createFailed: 'Tạo không gian làm việc thất bại'
    },
  ...
  input: {
    ...
    fileUpload: {
      ...
      label: 'Tải tệp lên',
      tooMany: 'Số lượng tệp tải lên vượt quá giới hạn',
      tooLarge: 'Kích thước tệp vượt quá giới hạn'
    }
  },
  integrations: {
  ...
  knowledgeBase: {
    ...
    createSessionError: 'Không thể bắt đầu phiên hội thoại',
  ...
  settings: {
    ...
    parser: {
      ...
      checking: 'Đang kiểm tra kết nối trình phân tích...'
    },
    ...
    sandbox: {
      ...
      backendDescriptions: {
        ...
        local: 'Chạy tập lệnh trực tiếp trong môi trường tiến trình máy chủ WeKnora'
      },

export default {
  ...
  modelSettings: {
    ...
    usage: {
      bindings: {
        ...
        vlm_model: 'Модель зрения (VLM)',
        asr_model: 'Модель речи (ASR)',
        wiki_synthesis_model: 'Модель синтеза Wiki',
        auto_tag_model: 'Модель авто-тегирования',
        ...
        extract_model: 'Модель извлечения',
        unknown: 'Неизвестное назначение',
      },
  ...
  model: {
    reasoning: {
      ...
      levelDescriptions: {
        off: 'Рассуждение отключено; модель отвечает напрямую.',
        auto: 'Модель сама выбирает интенсивность рассуждения по умолчанию.',
        minimal: 'Минимальное рассуждение; самый быстрый ответ.',
        low: 'Лёгкое рассуждение для простых вопросов.',
        medium: 'Баланс между рассуждением и скоростью.',
        high: 'Интенсивное рассуждение для сложных задач.',
        xhigh: 'Очень интенсивное рассуждение; ответ медленнее.',
        max: 'Максимальные усилия рассуждения для самых сложных задач.',
      },
    },
  ...
  knowledgeEditor: {
    ...
    faqImport: {
      ...
      fileTip: 'Поддерживаются JSON / CSV / Excel. Заголовки CSV/Excel: Тег (обязательно), Вопрос (обязательно), Похожие вопросы (необязательно, разделять через ##), Отрицательные вопросы (необязательно, разделять через ##), Ответы бота (обязательно, разделять через ##), Отвечать на всё (необязательно, по умолчанию FALSE), Отключено (необязательно, по умолчанию FALSE), Исключить из рекомендаций (необязательно, по умолчанию FALSE). Также поддерживаются старый заголовок «Категория» и формат: standard_question, answers, similar_questions, negative_questions',
  ...
  memory: {
    ...
    health: {
      ...
      emptyDesc: 'Данные о здоровье для этой базы знаний отсутствуют. Запустите проверку здоровья для создания отчёта.',
      totalMemories: 'Всего воспоминаний',
      fixed: 'Закреплено',
      refuted: 'Опровержено',
      orphans: 'Сироты',
      stale: 'Устаревшие',
      distByType: 'Распределение по типу',
      noData: 'Нет данных',
      issuesBySeverity: 'Проблемы по серьёзности',
      noIssues: 'Нет проблем',
      issues: 'Проблемы',
      viewMemory: 'Просмотр',
      applySuggestion: 'Применить исправление',
    ...
    time: {
      ...
      hoursAgo: '{n} ч. назад',
      daysAgo: '{n} дн. назад',
      eventsShown: '{shown} / {total} событий'
    },
    drawer: {
      historyEvents: {
        created: 'Создано',
        updated: 'Обновлено',
        deleted: 'Удалено',
        verdictChanged: 'Изменён вердикт',
        dreamer: 'Воспоминание',
        consolidated: 'Консолидировано',
        pruned: 'Обрезано',
        healthCheck: 'Проверка состояния',
      },
      title: 'Детали воспоминания',
      loading: 'Загрузка деталей воспоминания...',
      verdict: 'Вердикт',
      verdictProtected: 'Защищённый вердикт (решение/зафиксировано) нельзя изменить',
      tier: 'Уровень',
      importance: 'Важность',
      content: 'Содержание',
      metadata: 'Метаданные',
      ...
      addTag: 'Добавить тег',
      relations: 'Связи',
      viewInGraph: 'Просмотреть в графе',
      noRelations: 'Нет связанных воспоминаний',
      lintIssues: 'Проблемы линтинга',
      noLintIssues: 'Проблем не найдено',
      history: 'История',
      noHistory: 'Нет недавней активности'
    },
    browse: {
      title: 'Воспоминания',
      searchPlaceholder: 'Поиск воспоминаний...',
      empty: 'Воспоминания не найдены',
      emptyDesc: 'Воспоминания создаются автоматически при взаимодействии агента. Начните разговор или загрузите документы, чтобы увидеть воспоминания.',
      loading: 'Загрузка воспоминаний...',
      viewModeGrid: 'В виде карточек',
      viewModeTable: 'В виде таблицы',
      filterType: 'Тип',
      filterVerdict: 'Вердикт',
      filterTier: 'Уровень',
      bulkVerdict: 'Установить вердикт',
      bulkImportanceUp: 'Важность +1',
      bulkImportanceDown: 'Важность -1',
    ...
    history: {
      ...
      emptyDesc: 'Действия, связанные с воспоминаниями, будут отображаться здесь после их создания, обновления или обработки.',
      filterAll: 'Все события',
      eventCount: '{count} событие(й)',
      noMatchingEvents: 'Нет подходящих событий',
      noMatchingDesc: 'Нет событий, соответствующих выбранному фильтру. Попробуйте другой фильтр.',
    ...
    graph: {
      ...
      emptyTitle: 'Граф недоступен',
      emptyDesc: 'Данные графа воспоминаний отсутствуют. Создайте несколько воспоминаний, связанных отношениями, чтобы увидеть граф.',
      legend: 'Легенда',
      nodeTypes: 'Типы узлов',
      verdict: 'Вердикт',
      decisionRing: 'Решение (синее кольцо)',
      refutedDimmed: 'Опровергнуто (приглушено)',
      hubScore: 'Хаб-оценка > 1.0',
      relations: 'Отношения',
      relatedTo: 'Связано с',
      justifies: 'Подтверждает',
      contradicts: 'Противоречит',
      interaction: 'Взаимодействие',
      clickNodeHint: 'Клик по узлу = перефокусировка',
      dragNodeHint: 'Перетаскивание узла = перемещение',
      scrollHint: 'Прокрутка = масштаб, перетаскивание фона = панорамирование'
    },
    card: {
      importance: 'Важность: {count}/10',
      stale: 'Устарело',
      staleTitle: 'Не использовалось {days} дн.'
    },
    tiers: {
      '0': 'Уровень 0',
      '1': 'Уровень 1',
  ...
  vectorStoreSettings: {
    fields: {
      addr: 'Адрес',
      api_key: 'API-ключ',
      buckets_num: 'Число сегментов',
      collection_name: 'Имя коллекции',
      collection_prefix: 'Префикс коллекции',
      database: 'База данных',
      desired_shard_count: 'Желаемое число шардов',
      ...
      knn_engine: 'Движок KNN',
      number_of_replicas: 'Число реплик',
      number_of_shards: 'Число шардов',
      password: 'Пароль',
      port: 'Порт',
      replica_number: 'Число реплик',
      replication_factor: 'Коэффициент репликации',
      replication_num: 'Число репликаций',
      scheme: 'Схема',
      shard_number: 'Число шардов',
      shards_num: 'Шарды',

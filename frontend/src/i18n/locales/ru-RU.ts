  ...
  tenantMember: {
    ...
    memory: {
      ...
      card: {
        ...
        tier: 'Уровень {level}',
        stale: 'Устарело',
        staleTitle: 'Не обновлялось {days} дн.',
      },
      types: {
      ...
      health: {
        loading: 'Загрузка отчёта о состоянии...',
        emptyTitle: 'Отчёт о состоянии недоступен',
        emptyDesc: 'Для этой базы знаний пока нет данных о состоянии.',
        totalMemories: 'Всего воспоминаний',
        fixed: 'Зафиксировано',
        refuted: 'Опровергнуто',
        orphans: 'Сироты',
        stale: 'Устарело',
        distByType: 'Распределение по типам',
        noData: 'Нет данных',

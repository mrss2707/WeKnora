export default {
  ...
  modelSettings: {
    ...
    usage: {
      bindings: {
        ...
        vlm_model: '비전 모델 (VLM)',
        asr_model: '음성 모델 (ASR)',
        wiki_synthesis_model: 'Wiki 합성 모델',
        auto_tag_model: '자동 태그 모델',
        chat_model: '채팅 모델',
        rerank_model: '리랭크 모델',
        query_understand_model: '쿼리 이해 모델',
  ...
  model: {
    reasoning: {
      ...
      levelDescriptions: {
        off: '추론을 끄고 모델이 바로 답변합니다.',
        auto: '모델이 기본 추론 강도를 선택합니다.',
        minimal: '최소한의 추론, 가장 빠른 응답.',
        low: '간단한 질문에 가벼운 추론.',
        medium: '추론 강도와 속도의 균형.',
        high: '복잡한 문제에 집중적인 추론.',
        xhigh: '매우 집중적인 추론, 응답이 느려집니다.',
        max: '가장 어려운 문제에 최대 추론 노력.',
      },
    },
    modelName: '모델 이름',
    defaultTag: '기본값',
  ...
  memory: {
    ...
    health: {
      ...
      emptyDesc: '이 지식 베이스에 대한 건강 데이터가 없습니다. 건강 검사를 실행하여 보고서를 생성하세요.',
      totalMemories: '전체 기억',
      fixed: '고정됨',
      refuted: '반박됨',
      orphans: '고아',
      ...
      distByType: '유형별 분포',
      noData: '데이터 없음',
      issuesBySeverity: '심각도별 문제',
      noIssues: '문제 없음',
      issues: '문제',
      viewMemory: '보기',
      applySuggestion: '수정 적용',
      lastChecked: '마지막 확인'
    },
    time: {
      justNow: '방금',
    ...
    drawer: {
      ...
      title: '메모리 상세',
      loading: '메모리 상세 정보 로딩 중...',
      verdict: '판정',
      verdictProtected: '보호된 판정(결정/고정)은 변경할 수 없습니다',
      tier: '등급',
      importance: '중요도',
      content: '내용',
      metadata: '메타데이터',
      ...
      relations: '관계',
      viewInGraph: '그래프에서 보기',
      noRelations: '관련 메모리 없음',
      lintIssues: '린트 문제',
      noLintIssues: '문제를 찾을 수 없음',
      history: '히스토리',
      noHistory: '최근 활동 없음'
    },
    browse: {
      ...
      empty: '메모리를 찾을 수 없습니다',
      emptyDesc: '메모리는 에이전트가 상호작용할 때 자동으로 생성됩니다. 대화를 시작하거나 문서를 업로드하면 여기에 메모리가 표시됩니다.',
      loading: '메모리 로딩 중...',
      viewModeGrid: '카드 보기',
      viewModeTable: '테이블 보기',
      filterType: '유형',
      filterVerdict: '판정',
      filterTier: '등급',
      bulkVerdict: '판정 설정',
      bulkImportanceUp: '중요도 +1',
      bulkImportanceDown: '중요도 -1',
      bulkDelete: '선택 삭제',
    ...
    history: {
      ...
      loading: '활동 기록 로딩 중...',
      emptyTitle: '아직 활동 없음',
      emptyDesc: '메모리가 생성, 업데이트 또는 처리되면 메모리 관련 활동이 여기에 표시됩니다.',
      filterAll: '모든 이벤트',
      eventCount: '{count}개 이벤트',
      noMatchingEvents: '일치하는 이벤트 없음',
      noMatchingDesc: '선택한 필터와 일치하는 이벤트가 없습니다. 다른 필터를 시도해 보세요.',
      viewMemory: '메모리 보기',
      loadMore: '더 불러오기',
      today: '오늘',
      yesterday: '어제'
    ...
    graph: {
      depth: '깊이',
      fitToScreen: '화면에 맞추기',
      centerGraph: '그래프 중앙 정렬',
      loading: '그래프 로딩 중...',
      emptyTitle: '그래프를 사용할 수 없음',
      emptyDesc: '메모리 그래프 데이터가 없습니다. 여러 메모리를 관계로 연결하여 그래프를 확인하세요.',
      legend: '범례',
      nodeTypes: '노드 유형',
      verdict: '판정',
      decisionRing: '결정 (파란색 링)',
      refutedDimmed: '반박됨 (흐리게)',
      hubScore: '허브 점수 > 1.0',
      relations: '관계',
      relatedTo: '관련',
      justifies: '정당화',
      contradicts: '모순',
      interaction: '상호작용',
      clickNodeHint: '노드 클릭 = 중심 재설정',
      dragNodeHint: '노드 드래그 = 재배치',
      scrollHint: '스크롤 = 확대/축소, 배경 드래그 = 이동'
    },
    card: {
      importance: '중요도: {count}/10',
      stale: '오래됨',
      staleTitle: '{days}일 동안 사용되지 않음'
    },
    tiers: {
      '0': '0단계',
      '1': '1단계',
  ...
  vectorStoreSettings: {
    fields: {
      ...
      http_port: 'HTTP 포트',
      index_name: '인덱스 이름',
      insecure_skip_verify: 'TLS 검증 건너뛰기',
      knn_engine: 'KNN 엔진',
      ...
      port: '포트',
      replica_number: '복제 수',
      replication_factor: '복제 계수',
      replication_num: '복제 수',
      scheme: '스킴',
      shard_number: '샤드 수',
      shards_num: '샤드 수',
      use_tls: 'TLS 사용',

export default {
  ...
  modelSettings: {
    ...
    usage: {
      bindings: {
        ...
        vlm_model: '視覚モデル (VLM)',
        asr_model: '音声モデル (ASR)',
        wiki_synthesis_model: 'Wiki 合成モデル',
        auto_tag_model: '自動タグモデル',
        chat_model: 'チャットモデル',
  ...
  model: {
    reasoning: {
      ...
      levelDescriptions: {
        off: '思考を無効にし、モデルが直接回答します。',
        auto: 'モデルが既定の推論強度を選択します。',
        minimal: '最小限の推論で最速の応答。',
        low: '簡単な質問には軽い推論。',
        medium: '推論強度と速度のバランス。',
        high: '複雑な問題には集中的な推論。',
        xhigh: '非常に集中的な推論で応答が遅くなります。',
        max: '最も難しい問題に最大限の推論。',
      },
    },
    modelName: 'モデル名',
  ...
  vectorStoreSettings: {
    fields: {
      ...
      collection_prefix: 'コレクション接頭辞',
      database: 'データベース',
      desired_shard_count: '希望シャード数',
      grpc_address: 'gRPC アドレス',
      ...
      http_port: 'HTTP ポート',
      index_name: 'インデックス名',
      insecure_skip_verify: 'TLS 検証をスキップ',
      knn_engine: 'KNN エンジン',
      number_of_replicas: 'レプリカ数',
      number_of_shards: 'シャード数',
      password: 'パスワード',
      port: 'ポート',
      replica_number: 'レプリカ数',
      replication_factor: 'レプリケーション係数',
      replication_num: 'レプリケーション数',
      scheme: 'スキーム',
      shard_number: 'シャード数',
      shards_num: 'シャード数',
      use_tls: 'TLS を使用',

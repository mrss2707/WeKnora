export default {
  ...
  vectorStoreSettings: {
    fields: {
      addr: 'Address',
      api_key: 'API key',
      buckets_num: 'Bucket count',
      collection_name: 'Collection name',
      collection_prefix: 'Collection prefix',
      database: 'Database',
      desired_shard_count: 'Desired shard count',
  ...
  memory: {
    ...
    graph: {
      ...
      emptyDesc: 'No memory graph data available. Create multiple memories linked by relations to see the graph.',
      legend: 'Legend',
      nodeTypes: 'Node Types',
      verdict: 'Verdict',
      decisionRing: 'Decision (blue ring)',
      refutedDimmed: 'Refuted (dimmed)',
      hubScore: 'Hub score > 1.0',
      relations: 'Relations',
      relatedTo: 'Related to',
      justifies: 'Justifies',
      contradicts: 'Contradicts',
      interaction: 'Interaction',
      clickNodeHint: 'Click node = refocus center',
      dragNodeHint: 'Drag node = reposition',
      scrollHint: 'Scroll = zoom, drag bg = pan'
    },
    history: {
      eventTypes: {
        created: 'Created',
      ...
      emptyDesc: 'Memory-related activities will appear here once memories are created, updated, or processed.',
      filterAll: 'All Events',
      eventCount: '{count} event(s)',
      noMatchingEvents: 'No matching events',
      noMatchingDesc: 'No events match the selected filter. Try a different filter.',
    ...
    browse: {
      ...
      emptyDesc: 'Memories are created automatically as the agent interacts. Start a conversation or upload documents to see memories here.',
      ...
      filterTier: 'Tier',
      bulkVerdict: 'Set verdict',
      bulkImportanceUp: 'Importance +1',
      bulkImportanceDown: 'Importance -1',
    ...
    drawer: {
      ...
      title: 'Memory Detail',
      loading: 'Loading memory details...',
      verdict: 'Verdict',
      verdictProtected: 'Protected verdict (decision/fixed) cannot be changed',
      tier: 'Tier',
      ...
      noRelations: 'No related memories',
      lintIssues: 'Lint Issues',
      noLintIssues: 'No issues found',
      history: 'History',
    ...
    time: {
      ...
      hoursAgo: '{n}h ago',
      daysAgo: '{n}d ago',
      eventsShown: '{shown} / {total} events'
    },
    health: {
      loading: 'Loading health report...',
      emptyTitle: 'Health Report Unavailable',
      emptyDesc: 'No health data available for this knowledge base. Run a health check to generate a report.',
      totalMemories: 'Total Memories',
      fixed: 'Fixed',
      refuted: 'Refuted',
      orphans: 'Orphans',
      stale: 'Stale',
      distByType: 'Distribution by Type',
      noData: 'No data',
      issuesBySeverity: 'Issues by Severity',
      noIssues: 'No issues',
      issues: 'Issues',
      viewMemory: 'View',
      applySuggestion: 'Apply Fix',
  ...
  memorySettings: {
    ...
    usage: {
      bindings: {
        ...
        vlm_model: 'Vision model (VLM)',
        asr_model: 'Speech model (ASR)',
        wiki_synthesis_model: 'Wiki synthesis model',
        auto_tag_model: 'Auto-tag model',
        chat_model: 'Chat model',
        rerank_model: 'Rerank model',
        query_understand_model: 'Query understanding model',
        follow_up_model: 'Follow-up question model',
  ...
  model: {
    reasoning: {
      ...
      levelDescriptions: {
        off: 'Thinking disabled; the model answers directly.',
        auto: 'The model picks its default reasoning intensity.',
        minimal: 'Minimal reasoning; fastest response.',
        low: 'Light reasoning for simple questions.',
        medium: 'Balanced reasoning effort and speed.',
        high: 'Intensive reasoning for complex problems.',
        xhigh: 'Very intensive reasoning; slower responses.',
        max: 'Maximum reasoning effort for the hardest problems.',
      },
    },

export default {
  ...
  modelSettings: {
    ...
    usage: {
      bindings: {
        ...
        summary_model: '摘要模型',
        image_processing_model: '图像处理模型',
        vlm_model: '视觉模型 (VLM)',
        asr_model: '语音模型 (ASR)',
        wiki_synthesis_model: 'Wiki 总结模型',
        auto_tag_model: '自动打标模型',
        chat_model: '对话模型',
        rerank_model: 'Rerank 模型',
        query_understand_model: '查询理解模型',
        follow_up_model: '追问模型',
        extract_model: '信息抽取模型',
        unknown: '未知用途',
      },
      title: '模型无法删除',
  ...
  memory: {
    ...
    health: {
      loading: '正在加载健康报告...',
      emptyTitle: '健康报告不可用',
      emptyDesc: '此知识库没有可用的健康数据。运行健康检查以生成报告。',
      totalMemories: '总记忆数',
      fixed: '已固定',
      refuted: '已驳回',
      orphans: '孤立记忆',
      ...
      distByType: '按类型分布',
      noData: '暂无数据',
      issuesBySeverity: '按严重程度分布',
      noIssues: '无问题',
      issues: '问题',
      viewMemory: '查看',
      applySuggestion: '应用修复',
      lastChecked: '上次检查'
    },
    time: {
      justNow: '刚刚',
    ...
    drawer: {
      ...
      loading: '正在加载记忆详情...',
      verdict: '判定',
      verdictProtected: '受保护的判定（决策/已固定）不可修改',
      tier: '层级',
      importance: '重要性',
      content: '内容',
      metadata: '元数据',
    ...
    browse: {
      ...
      empty: '未找到记忆',
      emptyDesc: '记忆会在代理交互时自动创建。开始对话或上传文档即可在此处查看记忆。',
      loading: '正在加载记忆...',
      viewModeGrid: '卡片视图',
      viewModeTable: '表格视图',
      filterType: '类型',
      ...
      filterTier: '层级',
      bulkVerdict: '设置判定',
      bulkImportanceUp: '重要性 +1',
      bulkImportanceDown: '重要性 -1',
      bulkDelete: '删除选中',
    ...
    history: {
      ...
      loading: '正在加载活动历史...',
      emptyTitle: '暂无活动',
      emptyDesc: '创建、更新或处理记忆后，与记忆相关的活动将显示在此处。',
      filterAll: '所有事件',
      eventCount: '{count} 个事件',
      noMatchingEvents: '无匹配事件',
      noMatchingDesc: '所选筛选条件没有匹配的事件。请尝试其他筛选条件。',
      viewMemory: '查看记忆',
      loadMore: '加载更多',
      today: '今天',
      yesterday: '昨天'
    ...
    graph: {
      ...
      loading: '正在加载图谱...',
      emptyTitle: '图谱不可用',
      emptyDesc: '没有记忆图谱数据。创建多个通过关系链接的记忆以查看图谱。',
      legend: '图例',
      nodeTypes: '节点类型',
      verdict: '判定',
      decisionRing: '决策（蓝色环）',
      refutedDimmed: '已反驳（暗淡）',
      hubScore: '中心分数 > 1.0',
      relations: '关系',
      relatedTo: '相关',
      justifies: '支持',
      contradicts: '矛盾',
      interaction: '交互',
      clickNodeHint: '点击节点 = 重新聚焦中心',
      dragNodeHint: '拖拽节点 = 重新定位',
      scrollHint: '滚轮 = 缩放，拖拽背景 = 平移'
    },
    card: {
      importance: '重要度：{count}/10',
      stale: '已过时',
      staleTitle: '{days} 天未使用'
    },
    tiers: {
      '0': '层级 0',
      '1': '层级 1',
  ...
  vectorStoreSettings: {
    fields: {
      ...
      http_port: 'HTTP 端口',
      index_name: '索引名称',
      insecure_skip_verify: '跳过 TLS 校验',
      knn_engine: 'KNN 引擎',
